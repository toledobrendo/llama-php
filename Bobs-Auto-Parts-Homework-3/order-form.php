...
?>
    ...
    <?php 
      ...
      foreach($listOfProducts as $listOfProduct){
                  echo '<tr class="row">
                          <td class="col-4">
                            '.$listOfProduct->name.'
                          </td>
                          <td class="col-3">
                            Php. '.$listOfProduct->price.'.00
                          </td>
                          <td class="col-2">
                            <input type="number" name="'.$listOfProduct->quantity.'
                            " maxlength="3" min="0" max="10" class="form-control"/>
                          </td>
                        </tr>';
      }
