			...
			<div class="card-body">
				...
				<div class="col 6">
					<ul class="list-group">
						...
						<li class="list-group-item">
							<a href="Bobs-Auto-Parts-Quantity/order-form.php">Bob's Auto Parts - Quantity</a>
						</li>

						<li class="list-group-item">
							<a href="Bobs-Auto-Parts-TaxAmount/order-form.php">Bob's Auto Parts - Tax Amount</a>
						</li>

						<li class="list-group-item">
							<a href="Bobs-Auto-Parts-Array/order-form.php">Bob's Auto Parts - Order Form: Array</a>
						</li>
