<?php
  ...
  function saveOrder($tireQty, $oilQty, $sparkQty, $totalAmount) {
    ...
    $file = @ fopen(DOCUMENT_ROOT.'/llama-php/Bobs-Auto-Parts-HW4/resource/orders.txt', 'ab');
  ...
  function getOrders() {
    try {
      $file = @ fopen(DOCUMENT_ROOT.'/llama-php/Bobs-Auto-Parts-HW4/resource/orders.txt', 'rb');
