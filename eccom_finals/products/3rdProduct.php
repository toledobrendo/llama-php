    ...
    <div class="container" align = "center">
      <div class="card">
        <div class="card-body">
          ...
          <div><img src="../images/3rdProduct.jpg"></div>
          <input type="hidden" name="image" min="0" value="3rdProduct.jpg"/>
          <br>
          <input type="hidden" name="productName" min="0" value="Gilgamesh, God King"/>
          <div>Gilgamesh, God King</div>
          <br>
          <div>Php 500</div>
          <br>
          <input type="hidden" name="price" value="500"/></td>
          <div>Quantity</div>
          <br>
