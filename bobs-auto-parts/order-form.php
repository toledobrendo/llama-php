            ...
            <form action="process-order.php" method="post">
               <table class="table">
                  ...
                  <tbody>
                     <?php
                     $items =array(
                           array('name' => 'tireQty', 'Description' => 'Tires', 'Price' => 100),
                           array('name' => 'oilQty', 'Description' => 'Oil', 'Price' => 10),
                           array('name' => 'sparkQty', 'Description' => 'Spark Plugs', 'Price' => 5)
                        );
                     ...
                     foreach ($items as $item) {
                        echo '<tr class="row">
                           ...
                           <td class="col-4">
                           <input type="text" name="' . $item['name'] . '" maxlength="3" class="form-control"/></td>
                           </tr>';
                     }
                     ?>
                     <tr class="row">
