              ...
              <thread>
                ...
                <tbody>
                  ...
                  <tr class="row">
                    ...
                    <tr class="row">
                          <td class="col-5">How did u find Bob's?</td>
                          <td class="col-4">
                              <select class="custom-select" name="find">
                                  <option value="regular">I'm a regular</option>
                                  <option value="tv">TB advertisment</option>
