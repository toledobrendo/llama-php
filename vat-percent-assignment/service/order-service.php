...
function saveOrder($tireQty,$oilQty, $sparkQty,$totalAmount){
	...
	$file =@fopen(DOCUMENT_ROOT.'/dragon-php/assignments/vat-percent/resource/order.txt','ab');
...
function getOrders(){
	...
	$file= @ fopen(DOCUMENT_ROOT.'/dragon-php/assignments/vat-percent/resource/order.txt','rb');
		if (!$file) {
