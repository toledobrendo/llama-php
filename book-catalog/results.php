...
<div class="card-body">
  <?php
    ...
    try {
      ...
      // 127.0.0.1 = localhost
      @ $db = new mysqli('localhost', 'gtech.dp', 'dp', 'testdp');
      ...
      $query = 'SELECT author.name as author_name, book.title, book.isbn,pic_url
        FROM book
        INNER JOIN author
      ...
      ?>
        <div class="card col-4 mx-1">
          <div class="card-body">
            <div class="row">
              <div class="col">
                <img src="image/<?php echo $row['pic_url']; ?>" width="150px" height="150px" alt="">
              </div>
              <div class="col">
